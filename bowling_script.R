...
output <- POST(link, body = body, encode = "json",verbose()) #send til POST og gem i output

fromJSON(content(output,type="text")) #print cumulativ score verificer at pointscoren er korrekt
